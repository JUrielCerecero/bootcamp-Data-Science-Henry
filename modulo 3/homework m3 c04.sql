...
create table Clientes (IdCliente int, Provincia varchar (50), Nombre_y_Apellido varchar (150), Domicilio varchar(250), Telefono varchar(15), 
Edad int (3), Localidad varchar(25), X varchar(25), Y varchar(25), Fecha_Alta date, Usuario_Alta varchar(25), Fecha_Ultima_Modificacion date, 
Usuario_Ultima_Modificacion varchar(25),
primary key (IdCliente));
create table Productos (IdProducto int, Concepto varchar(60), Tipo varchar(20), Precio float(2),
primary key (Idproducto));
create table Proveedores (IDProveedor int, Nombre varchar(40), Address varchar(50), City varchar (25),
...
create table TipoDeGasto (IdTipoGasto int, Descripcion varchar(15), Monto_Aproximado int,
primary key(IdtipoGasto));
create table Venta(IdVenta int, Fecha date, Fecha_Entrega date, IdCanal int, IdCliente int, IdSucursal int, IdEmpleado int, IdProducto int, Precio float(2), Cantidad int,
primary key(Idventa),
...
alter table clientes add column col10  varchar (10);
alter table clientes add column Marca_Baja int after Usuario_Ultima_Modificacion;
alter table clientes modify column localidad varchar(60);
...
alter table proveedores modify column city varchar (30);
...
FIELDS TERMINATED BY ','
IGNORE 1 LINES;
alter table tipodegasto modify column Descripcion varchar(20);
...
/* error al cargar la tabla por doble primary key*/
