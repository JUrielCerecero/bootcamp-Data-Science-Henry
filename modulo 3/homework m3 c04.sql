...
create table Venta(IdVenta int, Fecha date, Fecha_Entrega date, IdCanal int, IdCliente int, 
IdSucursal int, IdEmpleado int, IdProducto int, Precio varchar(15), Cantidad varchar(10));
/*primary key(Idventa)*/
